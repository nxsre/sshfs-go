...
var RootCmd = &cobra.Command{
	Use:   "sshfs",
	Short: "use Docker's volumes to mount sshfs",
	Long:  `use Docker's volumes to mount sshfs`,
}
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is /etc/sysconfig/sshfs)")
...
func initConfig() {
	...
	viper.SetConfigName("sshfs")          // name of config file (without extension)
